...
c = b.reshape((4,2)) #tek boyutlu matristen 4x2lik matrise dönüştürüyoruz.
# print(c)
...
f = b.reshape((4,2))
# print(f)
f2  = f.T #transpoz alma işlemi.
# print(f2)

f3 = np.dot(f2,f) #matris çarpımı yapmamıza yarar. önce 1. matris satır sonra 2. matris sütunları ile çarp ve yaz.
# print(f3)
