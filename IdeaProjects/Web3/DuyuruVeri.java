...
public class DuyuruVeri {
    public List<Duyuru> duyuruGetir() throws Exception {
        ...
        try {
            ...
            while (sonuc.next()) {
                ...
                String gosterimtarihi = sonuc.getString("gosterimtarihi");
                String bitistarihi = sonuc.getString("bitistarihi");
    ...
    public void duyuruEkle(Duyuru duyuru1) {
        ...
        try{
            ...
            ifade.setString(3, duyuru1.getGosterimtarihi());
            ifade.setString(4, duyuru1.getBitistarihi());
            ifade.executeUpdate();
        } catch (SQLException e) {
            throw new RuntimeException(e);
        } catch (ClassNotFoundException e) {
